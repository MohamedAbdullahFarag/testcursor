...
const config: OIDCConfig = {
    ...
    baseUrl: process.env.NODE_ENV === 'production' ? import.meta.env.VITE_APP_BASE_URL : 'http://localhost:5000',
    authUrl: `${import.meta.env.VITE_APP_AUTH_URL}mga/sps/oauth/oauth20`,
    oauth20LogoutUrl: `${import.meta.env.VITE_APP_AUTH_URL}pkmslogout?redirect=${process.env.NODE_ENV === 'production' ? import.meta.env.VITE_APP_BASE_URL : 'https://localhost:5000'}`,
