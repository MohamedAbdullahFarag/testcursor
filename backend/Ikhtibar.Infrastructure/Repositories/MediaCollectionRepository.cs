...
using CoreEntities = Ikhtibar.Shared.Entities;
...
namespace Ikhtibar.Infrastructure.Repositories
{
    ...
    public class MediaCollectionRepository : BaseRepository<CoreEntities.MediaCollection>, IMediaCollectionRepository
    {
        ...
        /// </summary>
        public async Task<IEnumerable<CoreEntities.MediaCollection>> GetByUserAsync(int userId, bool includePrivate = true, int offset = 0, int limit = 50)
        {
        ...
        /// </summary>
        public async Task<IEnumerable<CoreEntities.MediaCollection>> GetContainingMediaFileAsync(int mediaFileId, bool publicOnly = true)
        {
        ...
        /// </summary>
        public async Task<int> GetMediaFileCountAsync(int collectionId)
        {
        ...
        /// </summary>
        public async Task<long> GetTotalSizeAsync(int collectionId)
        {
        ...
        /// </summary>
        public async Task<int> IncrementViewCountAsync(int collectionId)
        {
        ...
        /// </summary>
        public async Task<bool> AddMediaFileAsync(int collectionId, int mediaFileId, int sortOrder = 0, string? caption = null, bool isFeatured = false)
        {
            ...
            try
            {
                ...
                var insertSql = @"
                    INSERT INTO MediaCollectionItems (CollectionId, MediaFileId, SortOrder, Caption, IsFeatured, CreatedAt)
                    VALUES (@CollectionId, @MediaFileId, @SortOrder, @Caption, @IsFeatured, @CreatedAt)";
        ...
        /// </summary>
        public async Task<bool> RemoveMediaFileAsync(int collectionId, int mediaFileId)
        {
        ...
        /// </summary>
        public async Task<int> UpdateSortOrderAsync(int collectionId, IEnumerable<int> mediaFileIds)
        {
        ...
        /// </summary>
        public async Task<IEnumerable<CoreEntities.MediaCollectionItem>> GetCollectionItemsAsync(int collectionId, int offset = 0, int limit = 100)
        {
        ...
        /// </summary>
        public async Task<IEnumerable<CoreEntities.MediaCollectionItem>> GetFeaturedItemsAsync(int collectionId, int limit = 5)
        {
        ...
        /// </summary>
        public async Task<CoreEntities.MediaCollection> DuplicateCollectionAsync(int collectionId, string newName, string newSlug, int userId)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    var insertCollectionSql = @"
                        INSERT INTO MediaCollections (Name, Description, Slug, CollectionType, IsPublic, IsFeatured, 
                                                     ViewCount, Tags, CreatedByUserId, CreatedAt, ModifiedAt, IsDeleted)
                        VALUES (@Name, @Description, @Slug, @CollectionType, @IsPublic, @IsFeatured, 
                                @ViewCount, @Tags, @CreatedByUserId, @CreatedAt, @ModifiedAt, @IsDeleted)";

                    await connection.ExecuteAsync(insertCollectionSql, newCollection, transaction);

                    // Get the ID of the newly inserted collection
                    var newCollectionId = await connection.QuerySingleAsync<int>("SELECT SCOPE_IDENTITY()", null, transaction);
