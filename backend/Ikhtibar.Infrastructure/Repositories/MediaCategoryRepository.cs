...
{
    private new readonly ILogger<MediaCategoryRepository> _logger;

    public MediaCategoryRepository(IDbConnectionFactory connectionFactory, ILogger<MediaCategoryRepository> logger)
        : base(connectionFactory, logger, "MediaCategories", "Id")
    {
        _logger = logger;
    }
    ...
    /// </summary>
    public async Task<IEnumerable<MediaCategory>> GetChildCategoriesAsync(int parentCategoryId, bool activeOnly = true)
    {
    ...
    /// </summary>
    public async Task<IEnumerable<MediaCategory>> GetDescendantCategoriesAsync(int parentCategoryId, bool activeOnly = true)
    {
    ...
    /// </summary>
    public async Task<IEnumerable<MediaCategory>> GetCategoryPathAsync(int categoryId)
    {
    ...
    /// </summary>
    public async Task<bool> HasChildrenAsync(int categoryId, bool activeOnly = true)
    {
    ...
    /// </summary>
    public async Task<bool> HasMediaFilesAsync(int categoryId, bool includeDescendants = false)
    {
    ...
    /// </summary>
    public async Task<int> GetMediaFileCountAsync(int categoryId, bool includeDescendants = false)
    {
    ...
    /// </summary>
    public async Task<int> UpdateSortOrderAsync(int? parentCategoryId, IEnumerable<int> categoryIds)
    {
