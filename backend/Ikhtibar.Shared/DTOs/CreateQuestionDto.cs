...
{
    /// <summary>
    /// Title of the question (kept for backwards compatibility)
    /// </summary>
    [StringLength(500)]
    public string Title { get; set; } = string.Empty;

    /// <summary>
    /// Content of the question (primary storage)
    /// </summary>
    [Required]
    ...
    /// </summary>
    public bool IsSystemQuestion { get; set; } = false;

    /// <summary>
    /// Whether the question allows partial credit
    /// </summary>
    public bool AllowsPartialCredit { get; set; } = false;

    /// <summary>
    /// Whether the question allows negative marking
    /// </summary>
    public bool AllowsNegativeMarking { get; set; } = false;
    ...
    /// <summary>
    /// Primary tree node id (used by services)
    /// </summary>
