...
/// </summary>
public interface IMediaMetadataRepository : IBaseRepository<MediaMetadata>
{
    /// <summary>
    ...
    Task<IEnumerable<MediaMetadata>> GetByMediaFileAsync(int mediaFileId, bool publicOnly = false);
    ...
    Task<MediaMetadata?> GetByKeyAsync(int mediaFileId, string metadataKey);
    ...
    Task<IEnumerable<MediaMetadata>> GetByGroupAsync(int mediaFileId, string metadataGroup, bool publicOnly = false);
    ...
    Task<IEnumerable<int>> SearchMetadataAsync(string searchTerm, string? metadataKey = null, bool searchableOnly = true);
    ...
    Task<int> BulkInsertAsync(int mediaFileId, IEnumerable<(string Key, string? Value, MetadataType Type, string? Group, bool IsSearchable, bool IsPublic)> metadata);
    ...
    Task<MediaMetadata> UpsertAsync(int mediaFileId, string metadataKey, string? metadataValue, MetadataType dataType, string? metadataGroup = null, bool isSearchable = false, bool isPublic = true);
    ...
    Task<bool> DeleteByKeyAsync(int mediaFileId, string metadataKey);
    ...
    /// <returns>Number of metadata entries deleted</returns>
    Task<int> DeleteByGroupAsync(int mediaFileId, string metadataGroup);
    ...
    Task<IEnumerable<int>> GetMediaFilesByMetadataAsync(Dictionary<string, string> criteria, bool matchAll = true);
